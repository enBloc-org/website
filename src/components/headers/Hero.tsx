...
const Hero = () => {
  return (
    ...
    >
      <div
        className='animate-slidein700 absolute z-10 mb-10 font-mono text-2xl tracking-tight text-white
      ...
      <div
        className='animate-slidein300 opacity-0 absolute z-0 h-[350px] w-[100%] sm:h-[650px] 
